...
if outlines[0].split("\t")[0] == "Chr1" and outlines[1].split("\t")[1:4] == ["5928","6427","AT1G01020"] and outlines[2].split("\t")[4:] == ["11649","12148","AT1G01030"]:
    result = "Passed"

if verbosity > 0:
    print "WriteOverlapLines " + result
if verbosity > 1:
    print "\tResult: " + str(outlines[0].split("\t")[0]) + " " + str(outlines[1].split("\t")[1:4]) + " " + str(outlines[2].split("\t")[4:])
...
if outlines[0].split("\t")[0] == "Chr1" and outlines[1].split("\t")[1:3] == ["5928","6427"] and outlines[2].split("\t")[3:] == ["AT1G01030","1"]:
    result = "Passed"

if verbosity > 0:
    print "WriteOverlapLines " + result
if verbosity > 1:
    print "\tResult: " + str(outlines[0].split("\t")[0]) + " " + str(outlines[1].split("\t")[1:3]) + " " + str(outlines[2].split("\t")[3:])
